...
function criarContasTeste(): void {
    ...
    // A função gerarNumeros através de contas.gerarNumero(), irá cadastrar o próximo número de conta no Array de contas em ContaController.
    // O objeto é enviado para cadastrar, cadastrar(conta: Conta)
